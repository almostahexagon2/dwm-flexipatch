...
#else
static const char *fonts[]               = { "CaskaydiaMono NFM:size=10" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "CaskaydiaMono NFM:size=10";
...
static const Key keys[] = {
	...
	*/
	...
	// SUKO IXA VE KJO
    { MODKEY,	             		XK_Insert,                  spawn,          SHCMD("xdotool type $(grep -v '^#' ~/.local/share/bookmarks | dmenu -i -l 20 | cut -d' ' -f1)") },	
	...
	{ MODKEY,                       XK_g,                       spawn,          SHCMD("librewolf")},
	{ MODKEY|ShiftMask,             XK_g,                       spawn,          SHCMD("vieb")},
	
	/*scripts */
	{ 0,                            XF86XK_Display,             spawn,          SHCMD("bash /home/kwinsee/scripts/displayctl.sh")},
	{ MODKEY,                       XK_z,                       spawn,          SHCMD("zathura \"$(fd .pdf | dmenu -i -l 10 )\" ")},
	{ MODKEY,                       XK_v,                       spawn,          SHCMD("mpv \"$(fd \".mkv|.webm|.mp4\" | dmenu -i -l 10 )\" ")},
	{ MODKEY,                       XK_F9,                      spawn,          SHCMD("bash /home/kwinsee/scripts/mount.sh")},

	{ MODKEY,                       XK_p,                       spawn,          SHCMD("case $(pstree | grep picom | wc -l) in 1) killall picom ;; 0) picom --backend xrender & ;; esac")},

	{ MODKEY,                       XK_i,                       spawn,          SHCMD("xdotool type $(echo "" | dmenu -p 'xo disu' | sed -f /home/kwinsee/scripts/replace.sed)")},
	{ MODKEY|ShiftMask,             XK_i,                       spawn,          SHCMD("xdotool type $(echo "" | dmenu -p 'xo disu vimaisojo' | sed -f /home/kwinsee/scripts/lri-ime.sed)")},
	/*keyboard layout on a budget*/
	/*
	{ MODKEY|Mod1Mask,              XK_Right_Bracket,            spawn,          SHCMD("xdotool type 」")},
	{ MODKEY|Mod1Mask,              XK_Left_Bracket,             spawn,          SHCMD("xdotool type 「")},
	*/
